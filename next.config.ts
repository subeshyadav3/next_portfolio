...
const cspHeader = `
  ...
  img-src 'self' blob: data: https: https://ssl.gstatic.com https://*.gstatic.com;
  font-src 'self' data: https://cdn.jsdelivr.net https://fonts.gstatic.com;
  frame-src 'self' https://www.youtube-nocookie.com https://upload-widget.cloudinary.com https://widget.cloudinary.com https://res.cloudinary.com https://drive.google.com https://docs.google.com https://*.google.com https://accounts.google.com https://*.googleusercontent.com https://googleads.g.doubleclick.net https://*.googlesyndication.com https://tpc.googlesyndication.com;
  object-src 'self' https://res.cloudinary.com;
  connect-src 'self' https://api.cloudinary.com https://*.google-analytics.com https://*.googletagmanager.com https://*.googleadservices.com https://*.googlesyndication.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.google.com https://drive.google.com https://ssl.gstatic.com https://*.gstatic.com;
