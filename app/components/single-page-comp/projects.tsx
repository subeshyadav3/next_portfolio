...
export default function ProjectsPage() {
  ...
  return (
    <div id='projects' className=" flex flex-col mt-10 sm:ml-[100px] lg:ml-[200px]   ">
        ...
        {!showMore && (
          <div className="flex justify-center mt-8">
            <button 
              ...
              className="px-5 py-3 text-base font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-700 dark:hover:bg-blue-600"
            >
              Show More Projects
            </button>
          </div>
