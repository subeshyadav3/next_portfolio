  ...
  return (
    <div id="home" className="h-screen mt-[100px]">
      <div className="flex justify-center items-center flex-col my-12">
        <h1
          className={`text-3xl sm:text-4xl lg:text-5xl font-bold opacity-0 ${animate ? "hero-anim-title delay-200 opacity-100" : ""}`}
        >
        ...
        <h1
          className={`text-2xl sm:text-3xl lg:text-3xl text-[#CDCDFF] mt-5 font-bold opacity-0 ${animate ? "hero-anim-title delay-300 opacity-100" : ""}`}
        >
          Fullstack Developer
        </h1>

        <p
          className={`md:w-[600px] sm:p-10 text-[#BDBDDD] py-10 w-full opacity-0 ${animate ? "hero-anim-title delay-400 opacity-100" : ""}`}
        >
        ...
        <div
          className={` opacity-0 ${animate ? "hero-anim-title delay-600 opacity-100" : ""}`}
        >
