...
Grammar carries between 20 and 25 marks in the SEE English exam, which makes it one of the most reliable ways to secure a good score. The marks are distributed across several topics: tenses carry about 5 to 6 marks, voice change is worth 3 to 4 marks, reported speech is another 3 to 4 marks, prepositions account for 2 to 3 marks, sentence transformation is worth 3 to 4 marks, and error correction adds another 2 to 3 marks. Master these core topics, and you can virtually guarantee yourself a strong grammar score.
...
In the SEE exam, pay particular attention to the differences between Present Simple and Present Continuous, Past Simple and Present Perfect, and Future Simple and Future Continuous. Knowing the time markers for each tense is the key to getting these questions right.

### Passive Voice in All Tenses

Here is how active verbs convert to passive across all tenses:
...
Let us look at some examples to see how this works in practice. "She writes a letter" becomes "A letter is written by her." "They are building a house" becomes "A house is being built by them." "He has finished the work" becomes "The work has been finished by him." And "She will teach English" becomes "English will be taught by her."
...
## SEE Grammar Practice Questions
...
1. Each of the students have a book.
2. If I was you, I would study harder.
3. She is married with a doctor.
4. The news are very good.
5. Everyone should bring their own lunch.
6. I don't know nothing about it.
...
Before your exam, make sure you have reviewed all twelve tense forms with examples, passive voice for all tenses, direct to indirect speech rules, common prepositions with verbs and adjectives, error correction patterns, sentence transformations, confusing word pairs, subject-verb agreement rules, article usage rules, and question tags.

## Last-Minute Tips

Here are some strategies that will help you in the exam. Read each question carefully — many errors hide in small words like a, the, is, and are. When doing voice or reported speech transformations, identify the tense first before applying the rules. Never change the meaning of the sentence during transformation. Watch for negative words like no one, which is singular, and none of, which can be plural. For prepositions, memorize common verb and preposition combinations. And manage your time wisely — aim to complete the grammar section within 30 minutes.
